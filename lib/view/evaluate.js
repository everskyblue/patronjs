import { getStructList } from "./analyzer.js";
import { vw_error, bind_error } from "./error.js";
...
export const call_directives = {
    ...
    'for': function (scope, evaluate, node, data, directives) {
        ...
        let new_data = JSON.parse(`{"${evaluate.name_var}": ""}`), after_node = node;
