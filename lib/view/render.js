import { setEvaluatorCode, output } from "./compile/evaluate.js";
import { get_text_script, get_style, each, resetID } from "./compile/nodes.js";
import { getStructList, list_nodes } from "./compile/directives.js";
    ...
    Object.keys(data).forEach(key => { 
        (function (key) {
            Object.defineProperty(newdata, key, {
                ...
                set: (newValue) => {
                    data[key] = newValue;
                    list_nodes.forEach(fn => {
                        const find_nodes = fn(key);
                        if (find_nodes.length > 0) {
                            output(find_nodes, newdata);
                        }
                    });
                }
            });
